...
namespace mvc_web_apijl.Models
{
    public partial class Sri
    {
        public Sri()
        {
            SriEstablecimientos1 = new HashSet<SriEstablecimientos1>();
            SriEstadosTributarios = new HashSet<SriEstadosTributarios>();
        }
        ...
        public ICollection<SriEstablecimientos1> SriEstablecimientos1 { get; set; }
        public ICollection<SriEstadosTributarios> SriEstadosTributarios { get; set; }
    }
}
